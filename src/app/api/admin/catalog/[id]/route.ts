...
// Fields the editor is allowed to PATCH. Anything not in this list is
// dropped silently. JSON columns (cautions, pairs_well_with, etc.) are
// regenerated by the enrichment pipeline, not edited inline.
